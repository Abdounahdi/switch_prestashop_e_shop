	...
	public function initForm()
	{
		...
		$this->fields_form[0]['form'] = array(
			...
			'input' => array(
				...
				array(
					'type' => 'file_lang',
					'label' => $this->trans('Background Image:'),
					'name' => 'background',
					'lang' => true,
					'desc' => $this->trans('Set coupon popup background image. Recommend dimenssion 370x400 (W x H).'),
				),
				array(
						'col' => 3,
						'type' => 'text',
				...
				array(
					...
					'name' => 'cookies_time',
					'desc' => $this->trans('Set cookie time in hours you want to store cookie in browser for hide coupon popup in frontend.'),
				),				
			),
			'submit' => array(
