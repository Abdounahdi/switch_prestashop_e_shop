...
class MigrateData
{
    ...
    {
        $this->loadedData = [];
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'czbannercmsblockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'czbannercmsblockinfo_lang` il ON il.`id_czbannercmsblockinfo` = i.`id_czbannercmsblockinfo`'
        );
    ...
    /**
     * Import the old BannerCmsBlock data in the new structure
     *
     * @return bool
     */
    public function insertData()
    {
        ...
        $czbannercmsblockinfo->text = reset($customTexts);
