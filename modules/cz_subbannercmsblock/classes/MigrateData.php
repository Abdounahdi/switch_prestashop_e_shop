...
class MigrateData
{
    ...
    {
        $this->loadedData = [];
        $texts = Db::getInstance()->executeS('SELECT i.`id_shop`, il.`id_lang`, il.`text` FROM `' . _DB_PREFIX_ . 'czsubbannercmsblockinfo` i
            INNER JOIN `' . _DB_PREFIX_ . 'czsubbannercmsblockinfo_lang` il ON il.`id_czsubbannercmsblockinfo` = i.`id_czsubbannercmsblockinfo`'
        );
    ...
    /**
     * Import the old SubBannerCmsBlock data in the new structure
     *
     * @return bool
     */
    public function insertData()
    {
        ...
        $czsubbannercmsblockinfo->text = reset($customTexts);
