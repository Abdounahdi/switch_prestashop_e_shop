...
class Cz_ImageSlider extends Module implements WidgetInterface
{
    ...
    protected function installSamples()
    {
        ...
        $description = array('','<div class="container">
        <div class="slide_content">
        <div class="headdings">
        <div class="headding_text">Up To 50% Off</div>
        <div class="sub_headding">Buy Finest Quality <span>Spices Here</span></div>
        <div class="button-shopnow"><a href="#" class="btn btn-primary">Shop Now</a></div>
        </div>
        </div>
        </div>',
        '<div class="container">
        <div class="slide_content">
        <div class="headdings">
        <div class="headding_text">Up To 30% Off</div>
        <div class="sub_headding">Buy Masala Spice <span>Recipes</span></div>
        <div class="button-shopnow"><a href="#" class="btn btn-primary">Shop Now</a></div>
        </div>
        </div>
        </div>');
        ...
        for ($i = 1; $i <= 2; ++$i) {
            ...
            foreach ($languages as $language) {
                ...
                $slide->description[$language['id_lang']] = $description[$i];
    ...
    protected function _postValidation()
    {
        ...
        if (Tools::isSubmit('submitSlider')) {
            if (!Validate::isInt(Tools::getValue('CZHOMESLIDER_SPEED')) && Tools::getValue('CZHOMESLIDER_SPEED') != '') {
    ...
    protected function _postProcess()
    {
        ...
        if (Tools::isSubmit('submitSlider')) {
            ...
            foreach ($languages as $language) {
                ...
                if (!empty($_FILES['image_'.$language['id_lang']]['tmp_name'])){
    ...
    {
        $this->context->controller->registerStylesheet('modules-czhomeslider', 'modules/'.$this->name.'/views/css/flexslider.css', ['media' => 'all', 'priority' => 150]);
        $this->context->controller->registerJavascript('modules-czhomeslider', 'modules/'.$this->name.'/views/js/jquery.flexslider-min.js', ['position' => 'bottom', 'priority' => 150]);
    }
