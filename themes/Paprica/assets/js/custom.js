...
$(document).ready(function () {
  ...
  // ---------------- Add Class megamenu ----------------------
  $("#horizontal-menu .sub-menu li:has(ul)")
    .parent()
    .parent()
    .addClass("megamenu");
  $("#czverticalmenublock ul#top-menu li:has(ul)")
    .parent()
    .parent()
    .addClass("megamenu");
  ...
  if (vmenu_items.length > vmax_elem) {
    $("#czverticalmenublock ul#top-menu").append(
      '<li class="more_menu"><a href="#" class="vertical-menu-item" data-depth="0">' +
        vmenu_more_title +
        '<span class="more_category"><i class="fa-icon add"></i></span></a></li>'
    );
  }
  $("#czverticalmenublock ul#top-menu .more_menu").click(function (event) {
    ...
    if ($(this).hasClass("active")) {
      ...
      $("#czverticalmenublock ul#top-menu .more_menu").html(
        '<a href="#" class="vertical-menu-item" data-depth="0">' +
          vmenu_more_title +
          '<span class="more_category"><i class="fa-icon add"></i></span></a>'
      );
    } else {
      vmenu_items.each(function (j) {
        if (j >= vmax_elem) {
      ...
      $("#czverticalmenublock ul#top-menu .more_menu").html(
        '<a href="#" class="vertical-menu-item" data-depth="0">' +
          vmenu_less_title +
          '<span class="more_category"><i class="fa-icon remove">&nbsp;</i></span></a>'
      );
    }
  });
  vmenu_items.each(function (j) {
...
function responsivecolumn() {
  if ($(document).width() <= 991) {
    ...
    // 	}
    // });
    $("#header #desktop_cart").insertAfter(
    ...
    // 	}
    // });
    // $("#czheadercmsblock").insertAfter(
    //   "#header .header-top .container .user-info"
    // );
    $("#header #desktop_cart").insertAfter(
      "#header .header-top-inner .container .horizontal-menu"
    );
  }
